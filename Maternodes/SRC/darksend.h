...
{
public:
    /// Is the input associated with this public key? (and there is 100000 ChainX - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of chainX.
