function(chx_apply TARGET REQUIRED SUBMODULE)
	...
	if (${SUBMODULE} STREQUAL "base")
		...
		# if it's chainx source dir, always build BuildInfo.h before

		chx_use(${TARGET} ${REQUIRED} Dev::buildinfo)
	...
	if (${SUBMODULE} STREQUAL "soldevcore")
		...
		chx_use(${TARGET} ${REQUIRED} Dev::base)
